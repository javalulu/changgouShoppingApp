...
public class BrandController {
    ...
    public Result<List<Map>> findBrandListByCategoryName(@PathVariable("categoryName") String categoryName) {
        List<Brand> brandListByCategoryName = brandService.findBrandListByCategoryName(categoryName);
        return new Result<>(true, StatusCode.OK, "查询成功", brandListByCategoryName);
    }
